...
const mostBlogs = (blogs) => {
  ...
  if (Object.keys(blogCount).length === 1) {
    return {
      author: Object.keys(blogCount)[0],
      blogs: blogCount[Object.keys(blogCount)[0]],
    }
  }
...
const mostLikes = (blogs) => {
  ...
  if (Object.keys(likeCount).length === 1) {
    return {
      author: Object.keys(likeCount)[0],
      likes: likeCount[Object.keys(likeCount)[0]],
    }
  }
  const author = Object.keys(likeCount).reduce((a, b) =>
